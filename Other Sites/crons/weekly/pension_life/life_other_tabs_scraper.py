...
def getDocuments(SecId):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=11&SecurityToken={SecId}%5D9%5D0%5DSAGBR%24%24LSA&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
...
def getRiskNRating(SecId):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=2&SecurityToken={SecId}%5D9%5D0%5DSAGBR%24%24LSA&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getPerformance(SecId):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=1&SecurityToken={SecId}%5D9%5D0%5DSAGBR%24%24LSA&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getManagement(SecId):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=4&SecurityToken={SecId}%5D9%5D0%5DSAGBR%24%24LSA&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getOverview(SecId):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=0&SecurityToken={SecId}%5D9%5D0%5DSAGBR%24%24LSA&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getPortfolio(SecId):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=3&SecurityToken={SecId}%5D9%5D0%5DSAGBR%24%24LSA&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
