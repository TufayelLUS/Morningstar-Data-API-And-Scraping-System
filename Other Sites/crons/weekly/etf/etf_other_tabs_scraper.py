...
input_file_path = '../../daily/etf/etf_sec_ids.txt'
...
def getDocuments(SecId, fund_type):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=11&SecurityToken={SecId}%5D22%5D0%5D{fund_type}&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
...
def getRiskNRating(SecId, fund_type):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=2&SecurityToken={SecId}%5D22%5D0%5D{fund_type}&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getPerformance(SecId, fund_type):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=1&SecurityToken={SecId}%5D22%5D0%5D{fund_type}&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getManagement(SecId, fund_type):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=4&SecurityToken={SecId}%5D22%5D0%5D{fund_type}&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getOverview(SecId, fund_type):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=0&SecurityToken={SecId}%5D22%5D0%5D{fund_type}&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getPortfolio(SecId, fund_type):
    ...
    link = f'https://lt.morningstar.com/3y3wd9echv/snapshot/default.aspx?tab=3&SecurityToken={SecId}%5D22%5D0%5D{fund_type}&Id={SecId}&ClientFund=0&CurrencyId=GBP'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
