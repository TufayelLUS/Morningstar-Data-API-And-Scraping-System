...
def getDocuments(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&tab=12&investmentType=SA'
    loaded = False
...
def getRiskNRating(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&tab=2&investmentType=SA'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getPerformance(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&tab=1&investmentType=SA'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getManagement(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&tab=4&investmentType=SA'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
    ...
    if other_share_classes_container:
        ...
        for link in all_links:
            final_data['otherShareClasses'].append({
                ...
                'link': 'https://www.morningstar.co.uk/uk/funds/snapshot/' + link['href']
            })
    return final_data
...
def getOverview(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&investmentType=SA'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
class Portfolio:
    ...
    def processEverything(self):
        link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={self.SecId}&tab=3&investmentType=SA'
        loaded = False
        for i in range(retry_count):
            proxy = pickProxy()
            proxies = {
    ...
    def getAssetAllocation(self, SecId):
        link = f'https://www.us-api.morningstar.com/sal/sal-service/fund/process/asset/v2/{SecId}/data?languageId=en-GB&locale=en-GB&clientId=EC&benchmarkId=category&component=sal-mip-asset-allocation&version=4.13.0'
        if not self.token:
            return {}
    ...
    def getFactorProfile(self, SecId):
        link = f'https://www.us-api.morningstar.com/sal/sal-service/fund/factorProfile/{SecId}/data?languageId=en-GB&locale=en-GB&clientId=EC&benchmarkId=category&component=sal-mip-factor-profile&version=4.13.0'
        if not self.token:
            return {}
        headers['Authorization'] = f'Bearer {self.token}'
        loaded = False
    ...
    def getStyleMeasures(self, SecId):
        link = f'https://www.us-api.morningstar.com/sal/sal-service/fund/process/stockStyle/v2/{SecId}/data?languageId=en-GB&locale=en-GB&clientId=EC&benchmarkId=category&component=sal-mip-measures&version=4.13.0'
        if not self.token:
            return {}
        headers['Authorization'] = f'Bearer {self.token}'
        loaded = False
    ...
    def getSector(self, SecId):
        link = f'https://www.us-api.morningstar.com/sal/sal-service/fund/portfolio/v2/sector/{SecId}/data?languageId=en-GB&locale=en-GB&clientId=EC&benchmarkId=category&component=sal-mip-sector-exposure&version=4.13.0'
        if not self.token:
            return {}
        headers['Authorization'] = f'Bearer {self.token}'
        loaded = False
    ...
    def getRegion(self, SecId):
        link = f'https://www.us-api.morningstar.com/sal/sal-service/fund/portfolio/regionalSector/{SecId}/data?languageId=en-GB&locale=en-GB&clientId=EC&benchmarkId=category&component=sal-mip-region-exposure&version=4.13.0'
        if not self.token:
            return {}
        headers['Authorization'] = f'Bearer {self.token}'
        loaded = False
    ...
    def getFinancialMetrics(self, SecId):
        link = f'https://www.us-api.morningstar.com/sal/sal-service/fund/process/financialMetrics/{SecId}/data?languageId=en-GB&locale=en-GB&clientId=EC&benchmarkId=category&component=sal-mip-financial-metrics&version=4.13.0'
        if not self.token:
            return {}
        headers['Authorization'] = f'Bearer {self.token}'
        loaded = False
    ...
    def getHoldings(self, SecId):
        ...
        link = f'https://www.us-api.morningstar.com/sal/sal-service/fund/portfolio/holding/v2/{SecId}/data?premiumNum=100&freeNum=25&languageId=en-GB&locale=en-GB&clientId=EC&benchmarkId=category&component=sal-mip-holdings&version=4.13.0'
        if not self.token:
            return {}
        headers['Authorization'] = f'Bearer {self.token}'
