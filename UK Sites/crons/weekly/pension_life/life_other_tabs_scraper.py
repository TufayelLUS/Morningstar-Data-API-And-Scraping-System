...
input_file_path = '../../daily/pension_life/life_sec_ids.txt'
            ...
            try:
                ...
                if overview.get('Flag'):
                    if overview.get('Flag') == 'Deleted':
                        addToDB('life_overview', overview, True)
                    else:
                        addToDB('life_overview', overview)
                    break
            ...
            try:
                ...
                if documents.get('Flag'):
                    if documents.get('Flag') == 'Deleted':
                        addToDB('life_documents', documents, True)
                    else:
                        addToDB('life_documents', documents)
                    break
            ...
            try:
                ...
                if risk_n_rating.get('Flag'):
                    if risk_n_rating.get('Flag') == 'Deleted':
                        addToDB('life_risk_n_rating', risk_n_rating, True)
                    else:
                        addToDB('life_risk_n_rating', risk_n_rating)
                    break
            ...
            try:
                ...
                if portfolio_data.get('Flag'):
                    if portfolio_data.get('Flag') == 'Deleted':
                        addToDB('life_portfolio', portfolio_data, True)
                    else:
                        addToDB('life_portfolio', portfolio_data)
                    break
