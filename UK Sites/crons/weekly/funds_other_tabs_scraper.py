...
# input_file_path = 'funds_sec_ids.txt'
input_file_path = '../daily/funds_sec_ids.txt'
...
def getDocuments(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&tab=12'
    loaded = False
...
def getRiskNRating(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&tab=2'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getPerformance(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&tab=1'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getManagement(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}&tab=4'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
def getOverview(SecId):
    ...
    link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={SecId}'
    loaded = False
    for i in range(retry_count):
        proxy = pickProxy()
        proxies = {
...
class Portfolio:
    ...
    def processEverything(self):
        link = f'https://www.morningstar.co.uk/uk/funds/snapshot/snapshot.aspx?id={self.SecId}&tab=3'
        loaded = False
        for i in range(retry_count):
            proxy = pickProxy()
            proxies = {
        ...
        for i in range(retry_count):
            try:
                ...
                if not risk_n_rating.get('rating') and not risk_n_rating.get('risk') and i < retry_count - 1:
                    continue
                # skip if no risk_n_rating and last retry
                if not risk_n_rating.get('rating') and not risk_n_rating.get('risk') and i == retry_count - 1:
